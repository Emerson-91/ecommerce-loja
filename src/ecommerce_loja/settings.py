"""
Django settings for ecommerce_loja project.
...
SECRET_KEY = 'django-insecure-#t!j#3gyoa0*je58c6a86w3ig8h84oabi$&mlyr!&e^*(f+br('
...
ROOT_URLCONF = 'ecommerce_loja.urls'
...
WSGI_APPLICATION = 'ecommerce_loja.wsgi.application'
